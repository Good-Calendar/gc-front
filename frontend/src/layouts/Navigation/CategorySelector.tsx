...
import { CategoryContext, DATE_CATEGORY } from "../../components/useCategory";
  ...
  return (
    <>
      {DATE_CATEGORY.map(category => (
        <Btn key={category} value={category} selected={selectedCategory === category} onClick={e => handlerCategory(e)}>
          {category}
        </Btn>
      ))}
    </>
